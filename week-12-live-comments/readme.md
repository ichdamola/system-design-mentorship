...
Design live chat for a streaming platform: thousands of viewers in one room, messages must broadcast in real time with low latency, moderation has to keep up.
...
- Pub/sub at fan-out scale
- Backpressure and message dropping
- Moderation (rate limits, slow mode, bans)
